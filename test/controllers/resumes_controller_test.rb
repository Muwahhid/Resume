...
class ResumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resume" do
    assert_difference('Resume.count') do
      post resumes_url, params: { resume: { Address: @resume.Address, DOB: @resume.DOB, Email: @resume.Email, Experience: @resume.Experience, Gender: @resume.Gender, Hobbies: @resume.Hobbies, LanguagesKnown: @resume.LanguagesKnown, Name: @resume.Name, Phone: @resume.Phone, Projects: @resume.Projects, Qualification: @resume.Qualification, School_name: @resume.School_name } }
    end
